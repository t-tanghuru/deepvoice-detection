...
**(2026.04.11)**
- Google Colab T4 GPU 환경 구축
- Edge TTS 3가지 목소리로 합성 음성 3,199개 생성
- 구글 드라이브 저장 및 WSL2로 다운로드
- 실제 음성 2,000개 data/real 폴더 구성

**(2026.04.12)**
- 오디오 정규화 (16kHz wav 통일) 스크립트 구현
- 1차 모델 학습 완료 (F1: 1.0000)
- 과적합 문제 인지 및 데이터 다양화 필요성 확인
- 샘플레이트 통일 후 재학습 진행
